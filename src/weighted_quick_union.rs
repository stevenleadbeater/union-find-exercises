...
impl WeightedQuickUnion {
    fn new(size: i64) -> WeightedQuickUnion {
        WeightedQuickUnion {
...
#[cfg(test)]
mod tests {
    use crate::weighted_quick_union::WeightedQuickUnion;

    #[test]
    fn new() {
        let answer = WeightedQuickUnion::new(10);
    ...
    #[test]
    fn union_1_2() {
        let mut answer = WeightedQuickUnion::new(10);
